package io.davida.utgl_admin.rapport_district.domain
...
@Entity
@Table(name = "RapportDistricts")
@EntityListeners(AuditingEntityListener::class)
class RapportDistrict {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "sdsp_id")
    var sdsp: OrganisationUnit? = null

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "rapport_id")
    var rapport: RapportPhaGDis? = null
